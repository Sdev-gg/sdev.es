...
export default function Reviews() {
  return (
    <section className="border-b border-gray-700 z-40  text-gray-50 py-32 px-4 md:px-8 overflow-hidden 2xl:px-60 mx-auto relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 mt-12 gap-4 mx-auto items-stretch text-left text-gray-400 place-items-start">
        <div className="flex flex-col gap-4">
          <div className="rounded-lg bg-gray-800 px-8 py-4">
            <div className="flex">
              <img
              ...
              <div>
                ...
                <small className="block text-blue-500 text-xs">
                  @darrylwilson
                </small>
              </div>
              <img
